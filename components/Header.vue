<template>
  <div class="sm:pt-10 bg-black bg-opacity-25">
    <div
      class="container px-5 py-10 mx-auto flex flex-wrap flex-col md:flex-row items-center"
    >
      <div
      ...
      <div class="w-full md:w-2/5 md:py-3 md:p-0 pb-3">
        <img
